    ...
    <div className="p-8    text-center">
      ...
      <div className="flex flex-wrap justify-center text-left gap-5">
        ...
        >
          ...
          <h3 className="mt-5 text-xl font-bold text-blue-800">Seamless Client Coordination</h3>
          <p className="mt-2 mb-4 text-sm text-black">
        ...
        >
          ...
          <h3 className="mt-5 text-xl font-bold text-blue-800">Efficient Marketing Campaigns</h3>
          <p className="mt-2 mb-4 text-sm text-black">
        ...
        >
          ...
          <h3 className="mt-5 text-xl font-bold text-blue-800">Exceptional Client Support</h3>
          <p className="mt-2 mb-4 text-sm text-black">
        ...
        >
          ...
          <h3 className="mt-5 text-xl font-bold text-blue-800">Optimize Revenue Operations</h3>
          <p className="mt-2 mb-4 text-sm text-black">
      ...
      <div
        className="w-full lg:w-[80%] mx-auto flex flex-col sm:flex-col lg:flex-row lg:justify-between items-center mb-[15%]"
        initial="hidden"
        animate="visible"
        variants={fadeIn}
      ...
      <div
        className="w-full lg:w-[80%] mx-auto flex flex-col sm:flex-col lg:flex-row justify-between items-center"
        initial="hidden"
        animate="visible"
        variants={fadeIn}
